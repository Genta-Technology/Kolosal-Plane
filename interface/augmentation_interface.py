...
from api.api_helper import start_knowledge_augmentation
...
def knowledge_augmentation_interface():
    ...
    if st.button("Validate Payload"):
        if validate_payload(st.session_state.knowledge_augmentation_config):
    ...
    if st.button("Start Augmentation"):
        ...
        if validate_payload(st.session_state.knowledge_augmentation_config) and st.session_state.job_id is None:
