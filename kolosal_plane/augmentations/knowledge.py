...
class Knowledge(Augmentation):
    ...
    def generate_next_conversation(self,
                                   ...
                                   responses: List[str],
                                   previous_documents: List[str]) -> Tuple[List[str], List[str], int, int]:
        """
        ...
        Returns:
            ...
            int: The total number of input tokens processed by the language model.
            int: The total number of output tokens generated by the language model
        """
        ...
        return next_questions, documents_used, input_token_count, output_token_count
